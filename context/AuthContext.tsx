        ...
        if (payload.user) {
            ...
            if (!isSyncOnly) {
                try {
                    ...
                    // The server must explicitly say 'jwt_auth_expired_token' for us to retry.
                    ...
                    // If the code is 'jwt_auth_invalid_token', it means the signature failed.
                    // This happens if MCO_JWT_SECRET changed or is missing.
                    if (code === 'jwt_auth_invalid_token' || msg.includes('invalid') || msg.includes('expired token')) {
