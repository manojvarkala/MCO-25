...
const Pricing: FC = () => {
    ...
    const gridClasses = subscriptionsEnabled
        ? "mt-10 grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch"
    ...
    return (
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className={gridClasses}>
                ...
                {/* Pay-Per-Exam Card */}
                <div className={`bg-gradient-to-br from-amber-400 to-orange-500 text-white rounded-2xl shadow-lg p-8 flex flex-col ${!subscriptionsEnabled ? 'lg:max-w-md' : ''}`}>
