    ...
    <ol>
        ...
        <li class="mt-2">
            ...
            <ul class="list-disc pl-5 mt-1">
                ...
                <li>In the "Exam Application URL(s)" field, enter the full URL of your React app (e.g., <code>https://exams.yourdomain.com</code>). If you use multiple URLs (like for Vercel previews), add each one on a new line.</li>
