    ...
    <div class="space-y-4 mt-6 text-base handbook-toc">
        ...
        <div>
            ...
            <ol class="list-decimal list-inside space-y-1 pl-4 mt-1" start="6">
                ...
                <li><a href="#ch8" data-chapter-index="10">Plugin Settings & Tools</a></li>
            </ol>
        </div>
        <div>
            ...
            <ol class="list-decimal list-inside space-y-1 pl-4 mt-1" start="9">
                ...
                <li><a href="#ch11" data-chapter-index="13">Exam Program Customizer</a></li>
                <li><a href="#ch12" data-chapter-index="14">Product Customizer</a></li>
                <li><a href="#ch13" data-chapter-index="15">AI Content Engine</a></li>
            </ol>
        </div>
        <div>
