...
const MasqueradeBanner: FC = () => {
    const { masqueradeAs, stopMasquerade } = useAuth();

    if (masqueradeAs === 'none') {
        return null;
    }
    
    const message = masqueradeAs === 'user' 
        ? 'You are currently viewing the app as a regular user.'
        : 'You are currently viewing the app as a visitor.';
