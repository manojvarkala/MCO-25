...
const Integration: FC = () => {
    ...
    const engineVersion = engineVersionMatch ? engineVersionMatch[1] : "2.9.0";
        ...
        <div className="space-y-8">
            ...
            <div className="bg-[rgb(var(--color-card-rgb))] p-8 rounded-xl shadow-lg border border-[rgb(var(--color-border-rgb))]">
                ...
                <div className="bg-amber-50 border-l-4 border-amber-500 p-4 mb-6 text-amber-800 text-sm">
                    ...
                    <p>This is the stable release with security patches for authentication, improved cache handling, and fixed CSS loading issues for guests.</p>
                </div>
